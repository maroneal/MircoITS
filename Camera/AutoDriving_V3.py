...
for frame in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):
        ...
        if len(contours) > 0:
                ...
                if cx >= RightLim:
                        ...
                        NoLine = 0
                        print ("Turn Right")
                        MESSAGE = "0;0;0;0;0;0;0;0;0;"+chr(DataRight)+";"
                        sock.send(MESSAGE)
                        sock.close()                    
                ...
                if cx < RightLim and cx > LeftLim:
                        if OnLine == 0:
                                ...
                                NoLine = 0
                                print ("On Track!")
                                MESSAGE = "0;0;0;0;0;0;0;0;0;"+chr(DataOnLine)+";"
                                sock.send(MESSAGE)
                                sock.close()
                ...
                if cx <= LeftLim:
                        ...
                        NoLine = 0
                        print ("Turn Left")
                        MESSAGE = "0;0;0;0;0;0;0;0;0;"+chr(DataLeft)+";"
                        sock.send(MESSAGE)
                        sock.close()
                ...
                if NoLine == 0:
                        ...
                        MESSAGE = "0;0;0;0;0;0;0;0;0;"+chr(DataNoLine)+";"
                        sock.send(MESSAGE)
                        sock.close()                        
