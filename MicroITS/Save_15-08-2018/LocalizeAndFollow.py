...
class ReadyToLocalize(object):
    ...
    def printPublishPosition(self, position):
        ...
        if self.osc_udp_client is not None:
            ...
            MESSAGE = "192.168.1.2;0;0;"+str(posXcm)+";"+str(posYcm)+";0;0;0;0;"+chr(0x80)+";"
...
if __name__ == "__main__":
    ...
    camera = PiCamera()
    camera.resolution = (CameraLength, CameraHeight)
    camera.framerate = 32
    ...
    # will be 3D, representing the width, height, and # of channels
        ...
        crop_img = image[CameraLength/2:CameraLength:, 0:CameraLength]
        ...
        if len(contours) > 0:
            ...
            if cx >= RightLim:
                ...
                NoLine = 0
                print ("Turn Right")
                MESSAGE = "192.168.1.2;0;0;0;0;0;0;0;0;"+chr(DataRight)+";"
                sock.send((MESSAGE).encode())
                sock.close()                    
            ...
            if cx < RightLim and cx > LeftLim:
                if OnLine == 0:
                    ...
                    NoLine = 0
                    print ("On Track!")
                    MESSAGE = "192.168.1.2;0;0;0;0;0;0;0;0;"+chr(DataOnLine)+";"
                    sock.send((MESSAGE).encode())
                    sock.close()
            ...
            if cx <= LeftLim:
                ...
                NoLine = 0
                print ("Turn Left")
                MESSAGE = "192.168.1.2;0;0;0;0;0;0;0;0;"+chr(DataLeft)+";"
                sock.send((MESSAGE).encode())
                sock.close()
            ...
            if NoLine == 0:
                ...
                MESSAGE = "192.168.1.2;0;0;0;0;0;0;0;0;"+chr(DataNoLine)+";"
                sock.send((MESSAGE).encode())
                sock.close()                        
        ...
        cv2.resizeWindow('Image', CameraLength*3, CameraHeight*3)
