/**
* This program draws the course of the robot on the circuit (square of 2m width). It needs one file called "log_format_remote_control_mm.csv" and can be generated from the Java program called "Parse_file" which parses a file generated by the main program "MicroITS" on the robot.
*/
...
void setup()
{
  ...
  positions = loadTable("log_format_remote_control_mm.csv", "header");
